        ...
        <ScrollView>
          <View style={styles.list}>
            <View style={styles.header}>
              <Text style={styles.label}>List Booking Process</Text>
              <TouchableOpacity
                onPress={() => {
                  this.refresh();
                }}
                    ...
                    <View style={{ flexDirection: "row" }}>
                      <View style={{ flex: 1 }}>
                        <View style={{ flexDirection: "column", margin: 10 }}>
                          ...
                          <View style={{ flexDirection: "row" }}>
                            <Text style={{ fontSize: 15 }}>Receiver</Text>
                            <Text
                              style={{
                                fontSize: 15,
                                marginLeft: 26,
                      ...
                      >
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() => {
                            this.props.navigation.navigate("Edit Booking", {
            ...
            <Text style={styles.label2}>List Booking Done</Text>
